...
public readonly struct AsyncEnumerableWithExtensionMethod<T>
{
    ...
    public AsyncEnumerableWithExtensionMethod(T[] source)
        => Source = source;         
}

public readonly struct CancellableAsyncEnumerableWithExtensionMethod<T>
{
    public readonly T[] Source;

    public CancellableAsyncEnumerableWithExtensionMethod(T[] source)
        => Source = source;         
}

public static partial class MyExtensions
{
    public static ValueTypeAsyncEnumerator<T> GetAsyncEnumerator<T>(this AsyncEnumerableWithExtensionMethod<T> source)
        => new(source.Source);

    public static ValueTypeAsyncEnumerator<T> GetAsyncEnumerator<T>(this CancellableAsyncEnumerableWithExtensionMethod<T> source, CancellationToken _ = default)
        => new(source.Source);
}
